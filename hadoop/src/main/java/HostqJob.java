...
public class HostqJob extends Configured implements Tool {
    public static class HostqMapper extends Mapper<LongWritable, Text, Text, Text> {
    ...
    public static class HostqReducer extends Reducer<Text, Text, Text, Text> {
    ...
    private Job getJobConf(String input, String output) throws IOException {
        ...
        job.setJarByClass(HostqJob.class);

        FileInputFormat.setInputPaths(job, new Path(input));
        job.setInputFormatClass(TextInputFormat.class);
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(Text.class);
        job.setMapperClass(HostqMapper.class);
        job.setJobName("HQ");
        ...
        job.setReducerClass(HostqReducer.class);
    ...
    static public void main(String[] args) throws Exception {
        int ret = ToolRunner.run(new HostqJob(), args);
        System.exit(ret);
    }
}